...
function setupSheet() {
  ...
  _tab(ss, 'Engagements', [
    ['account_key','type','saleMonth','duration','grossK','prob','isY3Origination','isAnchor','title','description'],
    ['Links to Accounts.key','Engagement type: CP=Concept Proposal · A=Advisory · S=Strategy · R=Retainer · RR=Retainer Renewal','Month number when the engagement is expected to be sold (1 = Jan 2026)','Engagement duration in months','Total fee in $K (gross, before haircuts)','Win probability 0.0–1.0 — edit this to update the weighted pipeline','TRUE if this is a Year 3+ origination engagement (applies lower default probability)','TRUE on exactly one row per account — this engagement drives the Gantt bar position and size','Short opportunity title shown in account card','Opportunity description shown in account card'],
    ["qiddiya", "A",   3, 18, 1400, 0.5,  false, true,  "Phase 3 Programme Governance Reset",            "Multi-contractor portfolio governance redesign as Qiddiya transitions to city-scale delivery. EPS baseline reset, schedule integrity framework for the 2030 Expo deadline."],
    ["qiddiya", "A",  16, 12,  700, 0.5,  false, false, "Digital Twin Operationalisation",               "Move from Omniverse POC to live operational twin — use case definition, IoT data governance, asset information requirements for FM handover. Ivan is the only advisor with live Omniverse deployment on this programme."],
    ["qiddiya", "S",   6, 12,  500, 0.3,  false, false, "",                                              ""],
    ["qiddiya", "S",  20,  9,  333, 0.3,  false, false, "",                                              ""],
    ["qiddiya", "R",  13, 24,  500, 0.5,  false, false, "PIF ROI Reporting & Assurance",                 "With PIF mandating 20% spending cuts, QIC leadership needs independent validation of EPC-reported delivery data for PIF board reporting. EY's independence from all EPCs is the structural credential."],
    ["qiddiya", "RR", 25, 12,  100, 0.5,  false, false, "",                                              ""],
    ["sar",     "CP",  4,  4,   60, 0.75, false, false, "Owner-Side Schedule Health Assessment",         "SAR relies on EPC-submitted P6 schedules with no confirmed owner-side baseline governance. Independent health assessment across Landbridge, Qiddiya link, and network expansion."],
    ["sar",     "A",   6,  9,  350, 0.45, false, true,  "EPMO Design & Programme Controls Framework",   "SAR is managing multiple concurrent capital programmes with no unified owner-side EPMO producing portfolio intelligence. Design the EPMO operating model, controls framework, and reporting architecture."],
    ["sar",     "S",  10,  6,  200, 0.3,  false, false, "Oracle OAC Capital Delivery Integration",       "OAC deployed for finance — capital project delivery data not integrated. The gap between financial reporting and programme delivery means SAR cannot present a coherent ROI picture to PIF."],
    ["sar",     "R",  13, 24,  100, 0.5,  false, false, "Smart Rail Digital Twin Strategy",              "SAR has publicly confirmed Digital Twin and 5G monitoring ambitions for track infrastructure. Long-life rail assets create the strongest Digital Twin business case of any infrastructure class."],
    ["expo",    "CP",  5,  6,   80, 0.8,  false, false, "Owner-Side Programme Assurance — Entry Brief",  "Concept proposal scoping EY's role as independent programme adviser above Bechtel PMC for Expo 2030 Riyadh."],
    ["expo",    "A",   8, 12,  900, 0.5,  false, true,  "Owner-Side Programme Assurance Above Bechtel",  "ERC receives all construction intelligence through Bechtel. Independent advisory: is the delivery trajectory credible for Oct 2030? Are 226 pavilion packages converging on schedule?"],
    ["expo",    "S",  12,  9,  400, 0.3,  false, false, "PMIS Strategy — 246-Entity Programme",          "PMIS architecture managing owner-delivered infrastructure and 246 participant-delivered pavilions in a single programme intelligence framework."],
    ["expo",    "R",  15, 24,  160, 0.5,  false, false, "iCCC & Smart Expo Strategy",                    "Integrated Command & Control for 42M visitors across 6km². Ivan's TASMU and KSPF iCCC experience is the direct credential."],
    ["expo",    "RR", 27, 12,  120, 0.5,  false, false, "Legacy Transition — Global Village Governance", "Post-Expo, 6km2 becomes Global Village permanent district. Full-lifecycle advisory: asset information management, FM data governance, Digital Twin continuity."],
    ["fifa",    "CP",  8,  6,  100, 0.8,  false, false, "Multi-City Stadium Governance — Entry Brief",   "Concept proposal scoping owner-side programme governance across 15 FIFA 2034 stadium sites in 5 cities."],
    ["fifa",    "A",  10, 12, 1200, 0.5,  false, true,  "Multi-City Stadium Programme Governance",       "15 stadiums across 5 cities, each with a separate PMC or EPC — WCA34 needs a unified owner-side programme intelligence framework."],
    ["fifa",    "A",  23, 15,  900, 0.4,  false, false, "ISO 19650 Information Management — Portfolio",  "15 stadiums, 50+ organisations producing BIM models in different formats. Without ISO 19650 at portfolio level, WCA34 will receive disconnected asset data."],
    ["fifa",    "S",  14,  9,  400, 0.3,  false, false, "Smart Stadium & Digital Twin Strategy",         "WCA34 has committed to technology redefining how fans interact at matches. Smart stadium strategy, Digital Twin for venue operations, iCCC for tournament operations."],
    ["fifa",    "R",  18, 12,  160, 0.5,  false, false, "FIFA Delivery Milestone Assurance",             "FIFA imposes formal delivery milestones and stadium certification requirements. Independent advisory: are 15 programmes on credible trajectories for the June 2034 tournament?"],
    ["roshn",   "CP", 17,  6,   50, 0.8,  false, false, "EPMO Governance Redesign — Entry Brief",        "Concept proposal scoping EPMO governance redesign as ROSHN scales to 7+ active regions simultaneously."],
    ["roshn",   "A",  19, 12,  700, 0.35, false, true,  "Multi-Region EPMO Governance Architecture",     "As ROSHN scales to 7+ regions, the EPMO governance model needs redesign — decision rights, cost consolidation architecture, and contractor management."],
    ["roshn",   "R",  22, 24,  100, 0.4,  false, false, "PIF Delivery Assurance Retainer",               "With 20% PIF spending cuts mandated, ROSHN leadership needs ongoing independent programme assurance across 7+ regions."],
    ["roshn",   "S",  23,  9,  300, 0.25, false, false, "SAP — PMWeb Integration Diagnostic",            "The ERP to PMWeb cost reconciliation gap is structural at portfolio scale. Ivan has solved this on Oracle at Qiddiya — the advisory is transferable."],
    ["kspf",    "CP", 13,  6,   71, 0.75, false, false, "Programme Intelligence — Entry Brief",          "Concept proposal scoping owner-side programme intelligence mandate above Parsons PMO at King Salman Park Foundation."],
    ["kspf",    "A",  15, 12,  900, 0.4,  false, true,  "Owner-Side Programme Intelligence",             "Independent review of programme performance above Parsons' delivery reporting. Is the schedule data accurate? Are cost-to-complete figures defensible?"],
    ["kspf",    "S",  20,  9,  400, 0.25, false, false, "Digital Twin Governance",                       "CEO confirmed Digital Twin in active development. The governance layer — data architecture, CDE design, asset information requirements — is open. Ivan's Omniverse POC is the direct credential."],
    ["kspf",    "R",  19, 24,  140, 0.5,  false, false, "iCCC Design & Smart City Integration",          "70,000 daily visitors projected. An Integrated Command & Control Centre is a mandatory operational requirement at this scale. Ivan's TASMU iCCC experience is the direct advisory credential."],
    ["kspf",    "RR", 31, 12,  100, 0.5,  false, false, "Construction-to-Operations Handover",           "With 2027 opening target, KSPF is approaching the handover phase. ISO 19650 asset information requirements, BIM-to-FM data governance, operational readiness advisory."],
    ["diriyah", "A",  13, 12, 1000, 0.4,  false, true,  "Owner-Side Programme Intelligence",             "DGDA receives all programme data through Mace. Independent advisory layer: is Mace's schedule and cost reporting accurate? Are packages converging on the 2027 Arena Block target?"],
    ["diriyah", "A",  26, 12,  550, 0.35, true,  false, "Digital Twin for Heritage Environment",         "Active construction + UNESCO conservation creates a unique Digital Twin mandate. Ivan's Omniverse experience is the credential."],
    ["diriyah", "S",  16,  9,  400, 0.3,  false, false, "Heritage Asset Information Management",         "A UNESCO World Heritage Site has asset information requirements beyond standard BIM governance — heritage documentation, conservation records, regulatory compliance."],
    ["diriyah", "S",  28,  6,  200, 0.25, false, false, "",                                              ""],
    ["diriyah", "R",  20, 24,  140, 0.5,  false, false, "Multi-Contractor Cost Control Governance",      "As Diriyah accelerates with multiple packages, an owner-side cost control framework above Mace is the governance gap."],
    ["ksia",    "CP", 15,  6,   71, 0.7,  false, false, "Multi-Firm Governance — Entry Brief",           "Concept proposal scoping owner-side programme governance above Mace, Bechtel, and Parsons delivery chains at KSIA."],
    ["ksia",    "A",  17, 12, 1000, 0.35, false, true,  "Owner-Side Multi-Firm Programme Governance",    "Three firms each managing separate scopes across 57km². KSIADC needs owner-side intelligence above all three firms simultaneously."],
    ["ksia",    "R",  21, 24,  160, 0.5,  false, false, "Expo 2030 Delivery Assurance",                  "Airport must be operational for Expo 2030. Independent assurance: is the current delivery trajectory credible for a 2030 operational opening?"],
    ["ksia",    "S",  22,  9,  400, 0.25, false, false, "ISO 19650 Information Management",              "Designed by Jacobs and Foster+Partners, delivered by Mace, Bechtel, and Parsons — five organisations producing disconnected asset data without ISO 19650 governance."],
    ["ksia",    "A",  30, 15,  700, 0.3,  true,  false, "Aviation Digital Twin Strategy",                "KSIA designed as an aerotropolis — 9 terminals, 6 runways, 57km² of airside and landside operations."],
    ["ksia",    "RR", 33, 12,  120, 0.5,  false, false, "",                                              ""],
    ["aramco",  "CP", 26,  6,  100, 0.6,  false, false, "Capital Programme Controls — Entry Brief",      "Initial assessment of capital programme controls maturity across Aramco's $40B+ annual capex portfolio."],
    ["aramco",  "A",  25, 12, 1200, 0.3,  true,  true,  "SAP — PMIS Cost Reconciliation Advisory",       "Structural mismatch between SAP PS/MM/FI actuals and PMIS committed/forecast data across Aramco's capital portfolio. Ivan resolved this at sovereign scale."],
    ["aramco",  "R",  28, 24,  160, 0.3,  false, false, "Capital Programme Controls Maturity",           "With $40B annual capex and dividend cuts creating pressure, Aramco needs independent assessment: are schedules trustworthy? Are cost-to-complete figures defensible?"],
    ["aramco",  "S",  29,  9,  500, 0.2,  false, false, "PMIS Strategy & Business Case",                 "An owner-side PMIS strategy advisory: is the current architecture fit for purpose at Aramco's scale?"],
    ["newmurabba", "CP", 25,  6,  100, 0.7,  false, false, "PMIS Strategy — Entry Brief",               "Concept proposal scoping owner-side PMIS strategy to consolidate data from Bechtel, Turner Arabia, and AECOM reporting chains."],
    ["newmurabba", "A",  27, 12,  700, 0.4,  true,  true,  "Owner-Side PMIS Strategy Above Three PMCs", "Three PMCs producing three report formats — NMDC cannot see the programme as a whole. Define the owner-side PMIS architecture consolidating all three PMC chains."],
    ["newmurabba", "S",  29,  9,  200, 0.25, false, false, "Multi-PMC Schedule Governance",             "Three PMCs submitting P6 schedules in different EPS structures with no owner-side baseline governance."],
    ["newmurabba", "A",  32, 12,  550, 0.35, true,  false, "FIFA 2034 Delivery Certainty",              "New Murabba's programme interface with FIFA 2034 stadium delivery creates a hard deadline governance requirement."],
    ["khazna",  "CP", 13,  6,   71, 0.7,  false, false, "Handover Intelligence — Entry Brief",           "Concept proposal scoping handover intelligence architecture connecting Turner & Townsend construction delivery to NexOps operational systems."],
    ["khazna",  "A",  14, 12,  600, 0.45, false, true,  "Construction-to-Operations Handover Intelligence", "NexOps has 5,000 operational documents but the data architecture connecting T&T construction delivery to NexOps operational systems is open. ISO 19650, BIM-to-FM, commissioning data integration."],
    ["khazna",  "R",  16, 24,  100, 0.5,  false, false, "NexOps Governance Framework",                   "Presight AI provides the platform. The governance framework above it — data quality standards, integration architecture — is open."],
    ["khazna",  "S",  18,  9,  280, 0.25, false, false, "Portfolio PMIS Strategy — 30+ Facilities",      "T&T manages construction delivery but Khazna leadership needs owner-side portfolio visibility across 30+ simultaneous construction and expansion phases."],
    ["khazna",  "A",  22, 12,  400, 0.35, false, false, "International Expansion Governance",            "With $26.2B financing and active international expansion, Khazna's programme governance model needs to scale globally."],
    ["rsg",     "CP", 27,  6,   71, 0.6,  false, false, "IOC Maturity Assessment",                       "IOC Operating Model is in place. The maturity question: is the IOC producing the operational intelligence RSG leadership needs? This is the next advisory mandate."],
    ["rsg",     "A",  26, 12,  700, 0.35, true,  true,  "Construction-Operations Concurrent Governance", "Phase 1 operational + Phase 2+ construction active simultaneously across a Belgium-scale footprint. Governing a programme that is simultaneously building and operating requires a governance architecture most advisors have never designed."],
    ["rsg",     "R",  29, 24,  120, 0.35, false, false, "PIF ROI Validation Retainer",                   "RSG under heaviest spending pressure of any PIF giga-project. Leadership needs ongoing independent ROI validation to present a credible case to PIF leadership."],
    ["rsg",     "S",  30,  9,  300, 0.25, false, false, "Asset Handover & FM Integration",               "As Phase 1 assets hand over from construction to operations, data quality of what PMCs deliver to RSG FM teams becomes a live operational risk."],
    ["taqa",    "CP", 26,  6,   71, 0.65, false, false, "Capital Controls — Entry Brief",                "Concept proposal scoping owner-side programme controls and PMIS governance across TAQA's multi-segment capital portfolio."],
    ["taqa",    "A",  27, 18,  800, 0.4,  true,  true,  "Owner-Side Capital Programme Controls",         "Owner-side capital programme controls and PMIS governance across generation, water and T&D portfolio — exactly the scale where no single owner-side controls layer currently exists."],
    ["taqa",    "R",  28, 24,  100, 0.45, false, false, "Energy & Water Asset-Performance Intelligence",  "Digital Twin operational intelligence and ISO 19650 information management across TAQA's generation, water, and T&D asset portfolio."],
    ["taqa",    "S",  29, 12,  350, 0.3,  false, false, "",                                              ""],
    ["taqa",    "A",  33, 12,  500, 0.35, true,  false, "",                                              ""],
    ["taqa",    "RR", 34, 12,   80, 0.4,  false, false, "",                                              ""],
    ["admd",    "CP", 27,  6,   71, 0.7,  false, false, "Oracle PMIS Governance — Entry Brief (Aldar)",  "Concept proposal scoping Oracle PMIS governance for Aldar Properties capital programme."],
    ["admd",    "CP", 30,  6,   57, 0.7,  false, false, "Oracle PMIS Governance — Entry Brief (Miral)",  "Concept proposal scoping Oracle PMIS governance for Miral capital programme."],
    ["admd",    "A",  26, 15, 1000, 0.4,  true,  true,  "Oracle PMIS Governance — Multi-Asset Portfolio", "Oracle PMIS governance and capital controls across Aldar Properties, Miral, and MODON — combined capital deployment creating programme oversight complexity no single developer has resolved at portfolio level."],
    ["admd",    "S",  28,  9,  400, 0.3,  false, false, "",                                              ""],
    ["admd",    "R",  27, 24,  160, 0.5,  false, false, "Digital Twin Lifecycle Advisory",               "Digital Twin lifecycle advisory and multi-asset portfolio controls across the combined master developer capital portfolio."],
    ["admd",    "A",  32, 12,  700, 0.35, true,  false, "",                                              ""],
    ["admd",    "S",  33,  9,  300, 0.25, false, false, "",                                              ""],
    ["admd",    "RR", 34, 24,  140, 0.45, false, false, "",                                              ""],
    ["tasmu",   "CP", 26,  6,   57, 0.65, false, false, "iCCC Re-engagement — Concept Proposal",         "Initial re-engagement scoping with TASMU programme leadership on iCCC governance continuity and platform evolution."],
    ["tasmu",   "A",  25, 18,  700, 0.45, true,  true,  "Smart City Platform Evolution & iCCC Governance", "Post-deployment platform evolution: extending the iCCC into new operational domains, integrating with ongoing capital delivery programmes, and building the digital twin operational intelligence layer."],
    ["tasmu",   "R",  28, 24,  120, 0.45, false, false, "Digital Twin Operational Intelligence",          "Digital Twin operational intelligence and post-deployment asset performance advisory — the layer not included in the original build mandate."],
